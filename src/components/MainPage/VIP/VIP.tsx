...
const slidesData = [
  {
    ...
    price: '2500 P/2 часа',
    description: `Оплачивается дополнительно к входному билету. После 2 часов действует поминутная тарификация`,
    button: '#'
  },
  {
    img: turinImg,
    ...
    price: '2500 P/2 часа',
    description:
      'Оплачивается дополнительно к входному билету. <br />После 2 часов действует поминутная тарификация',
    button: '#'
  }
];
