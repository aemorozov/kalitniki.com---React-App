                ...
                <div className={'otzuv'}>
                  ...
                  <div className={'otzuv-text'}>
                    <p>
                      ...
                      компанией и не попали во время скидок, нам пошли на
                      встречу и это очень круто!! Профессиональный банщик с
                      большим веером круто всех пропарил, особенно пар с
                      палынькой и цитрусом!!! Всем рекомендую!
                    </p>
                  </div>
                ...
                <div className={'otzuv'}>
                  ...
                  <div className={'otzuv-text'}>
                    <p>
                      ...
                      тут такая домашняя и комфортная обстановка. Народу не
                      много, пар мягкий, банщик Андрей прекрасен. Очень
                      рекомендую попробовать у него паренье со льдом. Это лучшее
                      из всех, что я пробовала. Да и очень вкусно кормят. В
                      общем — рекомендую. Единственно, имейте в виду, что
                      женские дни — это только понедельник и вторник. Но
                      администрация обещала добавить как минимум еще один день)
                    </p>
                  </div>
                  <button className={'otzuv-button'}>Читать больше</button>
                </div>
